class Ship
  ...
  def self.create(arr, x, y, sizze, position)
    ...
    if position == :o
      ...
      if y > 1 && (x == 1 && arr[x + 1][y + sizze] != @condition or arr[x + 1][y - 1] != @condition)
      ...
      if x > 1 and y > 1 && (x == @n && arr[x - 1][y - 1] != @condition or arr[x - 1][y + sizze] != @condition)
        return false
      end
      # ship is on the left checking the intersection right top and bottom
      return false if x > 1 && (y == 1 && arr[x - 1][y + sizze] != @condition or arr[x + 1][y + sizze] != @condition)
      ...
      return false if y > 1 && (y == @m && arr[x + 1][y - 1] != @condition)
      # checking around the ship on intersection when ship is not on margins
      if x > 1 and y > 1 && (arr[x - 1][y - 1] != @condition or arr[x + 1][y - 1] != @condition or arr[x - 1][y + sizze] != @condition or arr[x + 1][y + sizze] != @condition)
        return false
      end
...
t.a = Ship.create t.a, 1, 3, 1, :o
t.a = Ship.create t.a, 2, 7, 1, :o
# t.a = Ship.create t.a,3,8,2,:o
